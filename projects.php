...
<div class="container">
      <div class="row mt-5 justify-content-start" data-aos="fade-right" data-aos-duration="500" >
      <?php for($i = 0 ;$i < count($project) ; $i++) :?>
        <div class="col-md-6 col-lg-4 col-xl-4 col-12 mt-5">
        <?php if(isset($_SESSION["admin"])): ?>
        <div class="tools d-flex justify-content-center mb-3">
              <a href="ubah.php?id=<?=$project[$i]["id"]?>"><i class="fa-solid fa-pen px-3 text-black"></i></a>
              <a href="hapus.php?id=<?=$project[$i]["id"]?>" onclick = "return confirm('Proyek Akan dihapus')"><i class="fa-solid fa-trash-can text-danger px-3"></i></a>
                      </div>
                      <?php endif;?>
          <div
          
            class="card mx-auto shadow-lg gallery-img"
            id="proyek"
            alt="gambar project"
            style=" width: 17rem;"
          >
            ...
            <div class="proyek1" style=" width: 17rem;
                  height: 18rem;
                  background-image: url(img/<?=$project[$i]["gambar"]?>);
            ...
            <div class="card-body">
              ...
              <?=$project[$i]["nama"]?><br />
                <span class="text-danger"><?=$project[$i]["tempat"]?></span>
              </p>
           
            <a href="catalog.php?id=<?=$project[$i]["id"]?>" class="btn btn-dark w-100">
              Selengkapnya
            </a>
...
<footer class="footer  py-3 bg-dark mt-3" >
