...
$id = $_GET["id"];
$project = query("SELECT gambar , gambar1 ,gambar2 ,gambar3  FROM project WHERE id = $id");
...
$totaldata = $gambar1 + $gambar2 + $gambar3;
...
<html lang="en">
  ...
  <!-- Title -->
    <title>Romax - Preview Project</title>
          ...
          >
            ...
            <div class="carousel-inner bg-dark">
              <div class="carousel-item active ">
                <div
                  class="box-carousel  bg-dark mx-auto"
                  style="
                    background-image: url(img/<?=$project[0]["gambar"]?>);
  ...
  <?php $y = $i+1 ?>
              <div class="carousel-item">
                <div
                  class="box-carousel  bg-dark mx-auto"
                  style="
                    background-image: url(img/<?=$project[0]["gambar$y"]?>);
                    background-position: center;
                    background-size: cover;
                  "
                ></div>
