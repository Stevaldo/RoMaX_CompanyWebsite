...
<html lang="en">
    <head>
      ...
      <!-- Title -->
        <title>Romax - Terima Kasih</title>
    ...
    <div class="container">
      <div class="row text-center" style="margin-top: 50vh">
        <div class="col" data-aos="fade-down">
          <h1 class="fw-bolder">Thank you we have received your email</h1>
          <p>
            <a href="index.php" class="text-danger fs-3 fw-bold">back to main page</a>
          </p>
        </div>
      </div>
    </div>
