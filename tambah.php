...
if(isset($_POST["tambah"])){
  ...
  if(insert("INSERT INTO project VALUES (
    '','$nama','$tempat','$gambar','$gambar1','$gambar2','$gambar3')")>0){
          echo "<script>
...
<head>
    ...
    <!-- FontAwesome -->
    <script src="https://kit.fontawesome.com/300d7bda41.js" crossorigin="anonymous"></script>
  <!-- Title -->
    <title>Romax - Tambah Proyek</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="rows justify-content-center d-flex form mx-auto">
        <div class="col-4 p-2 justify-content-evenly d-flex align-items-center">
          <label for="gambar" class="fw-bold fs-5">Gambar Thumbnail</label>
        </div>
        <div class="col-8 p-2 justify-content-evenly d-flex align-items-center">
          <input  required
            type="file"
      ...
      <div class="rows justify-content-center d-flex form mx-auto">
        ...
        >
          <p class="text-secondary">Semua Data harus Di isi kecuali Gambar 1-3</p>
        </div>
